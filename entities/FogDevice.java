...
public class FogDevice extends PowerDatacenter {
    ...
    public FogDevice(
            ...
            double uplinkBandwidth, double downlinkBandwidth, double uplinkLatency, double ratePerMips,int horizontal, int vertical) throws Exception {
    ...
    public FogDevice(
            ...
            double uplinkBandwidth, double downlinkBandwidth, double ratePerMips, PowerModel powerModel, int horizontal, int vertical) throws Exception {
